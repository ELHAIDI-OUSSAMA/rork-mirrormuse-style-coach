...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, ...typo.body, color: palette.ink },
  sectionCard: { marginHorizontal: space.screen, marginBottom: space.md },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  sectionTitle: { ...typo.bodyMedium, color: palette.ink },
  sectionSubtitle: { ...typo.small, color: palette.inkMuted, marginTop: 2 },
  ...
  pillTitle: { ...typo.small, color: palette.inkLight },
  pillMeta: { ...typo.caption, color: palette.secondaryDark },
  ...
  cardPrice: { ...typo.bodyMedium, color: palette.accentDark, marginTop: 2 },
  cardMeta: { ...typo.small, color: palette.inkMuted, marginTop: 2 },
  emptyWrap: { alignItems: 'center', paddingTop: 60 },
  emptyTitle: { ...typo.sectionHeader, color: palette.ink },
  emptySubtitle: { ...typo.body, color: palette.inkMuted, marginTop: 6, textAlign: 'center' },
});
